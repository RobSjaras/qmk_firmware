...
[MAC_BASE] = LAYOUT_ansi_82(
     ...
     KC_CAPD,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_PGDN,
    ...
    switch (keycode) {
        ...
        case KC_CAPS_DELAY:
            if (record->event.pressed) {
                ...
                if (timer_elapsed(key_timer) > TAP_HOLD_CAPS_DELAY) {
